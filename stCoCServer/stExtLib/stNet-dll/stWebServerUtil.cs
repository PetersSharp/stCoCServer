...
namespace stNet.stWebServerUtil
{
    ...
    {
        private const string _outFile = @"concat";
        private string _listFile = @"concat.list.*";
        ...
        /// <summary>
        /// List concat files in directory search
        /// </summary>
        public string ListFile
        {
            get { return this._listFile; }
            set { this._listFile = value; }
        }
        /// <summary>
        /// List concat files full file name
        /// </summary>
        public string ListFileName(string dir)
        {
            return this._listFile + dir;
        }
        /// <summary>
        ...
        public void Minify(string fpath, Action<string> actwatch = null)
        {
            ...
            foreach (string lstfn in Directory.GetFiles(fpath, _listFile, System.IO.SearchOption.AllDirectories))
            {
                ...
                try
                {
                    ...
                    fnw = Path.Combine(
                        ...
                        ((this._isConcat) ? 
                            ((this._isMinify) ? 
                                _outFile + ".min" + Path.GetExtension(lstfn) :
                                _outFile + Path.GetExtension(lstfn)
                            ) :
                            ((this._isMinify) ? 
