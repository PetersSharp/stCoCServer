...
namespace stRrd.Graph
{
	...
	public class RrdGraphDef
	{
        ...
        private Bitmap     backgroundBitmap = null;							// no background image by default
        private FileStream backgroundStream = null;							// no background image by default
		...
		/// </summary>
		/// <returns></returns>
		public FileStream GetBackgroundStream()
		{
		...
		/// 
		/// </summary>
		public string BackgroundStream
		{
			set
			{
				if ( File.Exists(value) )
					this.backgroundStream = new FileStream(value, FileMode.Open, FileAccess.Read);
			}
		}
        ...
        /// 
        /// </summary>
        public Bitmap BackgroundResource
        {
            set
            {
                this.backgroundBitmap = (Bitmap)value;
            }
        }
