...
namespace stCoreUI
{
	public class FlatListBox : Control
	{
        ...
        /// <summary>
        /// FindAndSelectItem method, find and sets the ListBox selected item property.
        /// </summary>
        /// <param name="search"></param>
        /// <returns></returns>
        public bool FindAndSelectItem(string search)
        {
            object obj;
            if ((obj = this.FindItemContains(search)) != null)
            {
                ListBx.SelectedItem = obj;
                return true;
            }
            return false;
        }
        ...
        /// <summary>
        /// FindItemContains method, find and return object item property.
        /// </summary>
        /// <param name="search"></param>
        /// <returns></returns>
        public object FindItemContains(string search)
        {
		...
		public FlatListBox() : base()
		{
            ...
            ListBx.ForeColor = Color.Gainsboro;
