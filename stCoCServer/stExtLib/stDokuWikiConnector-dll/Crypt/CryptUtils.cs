...
/*
 *  original: Alfred Hall, https://github.com/ahall
 *  PasswordSharp
 *  Safe password hashing library for C#
 *  This code is heavily based on https://gist.github.com/1092558.
 */
...
namespace stDokuWiki.Crypt
{
    ...
    public class CryptUtils
    {
        ...
        public const string DefaultType = TypeMd5;
        ...
        public static string MakeSalt(string algoType, int rounds)
        {
            ...
            switch (algoType)
            {
                case TypeMd5: { saltChars = 8; break; }
                default: { saltChars = 16; break; }
            }
            ...
            return string.Format("{0}{1}", algoType, Convert.ToBase64String(randomBytes));
        }
